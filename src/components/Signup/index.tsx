    ...
    <div className="signin-bg bg-[#010A12CC]/100 w-full h-full min-h-[100vh]  relative">
      ...
      <div className="flex justify-center items-center relative mt-[138px] px-5 flex-col mob:px-12">
        <div className="signin-gradient w-full max-w-[562px] py-[58px] px-[60px] mob:px-[40px] mob:py-[38px] border-[0.5px] border-[#fff]/20 rounded-[20px] mob:mb-[138px] ">
          <Text className="text-[#fff] font-bold text-[48px] mob:text-[24px] mob:text-center">
            Sign Up
          </Text>
          ...
          /> */}
            ...
            />
            <button
              className="w-full max-w-[437px] h-[53px] signin-btn-gradient text-[#fff] font-semibold rounded-[5px] text-[16px]"
              type="submit"
            >
              Sign Up
            </button>
          </form>
          <Text className="font-[300] text-[16px] mb-4 text-[#fff] mt-[33px] mob:text-center hidden mob:block">
