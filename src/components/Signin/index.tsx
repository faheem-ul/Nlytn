    ...
    <div className="signin-bg bg-[#010A12CC]/100 w-full min-h-[100vh]  h-full relative ">
      ...
      <div className="flex justify-center items-center relative mt-[138px]  flex-col px-5 mob:px-12 ">
        ...
        <div className="signin-gradient w-full max-w-[562px] py-[58px] px-[60px] mob:px-[40px] mob:py-[38px] border-[0.5px] border-[#FFFFFF]/20 rounded-[20px] mob:mb-[138px]">
          <Text className="text-[#fff] font-bold text-[48px] mob:text-[24px] mob:text-center shadow">Sign in</Text>
          ...
          <Text className="font-[300] text-[16px] mb-4 text-[#fff] mt-[33px] hidden mob:block text-center mob:leading-[22px]">Donot have an account? <span className="text-[#058FFD] cursor-pointer" onClick={()=>{
          navigate('/signup');
        }}>Sign up</span></Text>
        <Text className="text-[#058FFD] text-[16px] font-light mob:block hidden text-center">Forgot password</Text>
        </div>
        <Text className="font-[300] text-[16px] mb-4 text-[#fff] mt-[33px] mob:hidden">Donot have an account? <span className="text-[#058FFD] cursor-pointer" onClick={()=>{
          navigate('/signup');
        }}>Sign up</span></Text>
        <Text className="text-[#058FFD] text-[16px] font-light mob:hidden">Forgot password</Text>
