...
const Worksapce: React.FC<props> = ({ flipHelpcenter }) => {
  ...
  const answers = [
    <div className="w-full flex gap-2 justify-start">
      <div className="w-full max-w-[550px] min-h-[60px] flex flex-wrap gap-[24px] border border-[#FFFFFF] rounded-[8px] p-4">
        {Array(10)
          .fill(0)
          .map((_, index) => (
            <img
  ...
  return (
    <div className="workspace-bg bg-[#010A12CC]/100 bg-opacity-80 w-full min-h-[100vh] h-full relative flex flex-col px-12 justify-center items-center">
      <div className="absolute inset-0 bg-[#000000] opacity-70 mob:bg-[#010A12]"></div>
      {/* <ResponsiveSidebar /> */}
      <div className="flex-1 mob:px-0 px-5 pb-[100px] mob:py-10 relative mt-16 mob:mt-0 w-full">
        <div className="flex flex-col items-start rounded-[20px] border border-solid border-white-a700 bg-gray-900 px-5 py-[34px] ">
          <div className="max-h-screen overflow-y-scroll w-full px-3">
            <div className="flex justify-between w-full custom-mine-scrollbar">
              <Heading
                as="h1"
            ...
            <Text
              as="p"
              className="mt-2 w-[44%] mob:text-[13px] mob:w-full mob:text-center text-[14px] mob:leading-[22px] font-light leading-[128%] text-gray-500 "
            >
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
              vulputate libero et velit interdum.
            </Text>
            <div
              className={`relative w-full border border-[#fff] rounded-t-[12px] input-gradient py-4 px-8 min-h-[60px] my-[24px] mob:block hidden
            `}
            >
              {/* Images preview area */}
              ...
              <input
                ...
                className={`w-full text-white-a700 bg-transparent font-semibold border-none outline-none focus:outline-none focus:ring-0 mob:px-4 ${
            ...
            <div className="max-w-[500px] w-full">
              <div className="border border-[#fff] w-full px-2 py-2 rounded-[23px] mb-[12px] flex justify-evenly mt-10">
                {answers.map((_, index) => (
                  <Text
                    key={index}
                    className={`font-semibold cursor-pointer text-white-a700 ${
                      currentAnswer === index + 1 ? " text-blue-custom" : ""
                    }`}
              ...
              <div className="w-full  mt-3 bg-white-a700 flex mb-[24px]">
                {answers.map((_, index) => (
                  <div
                    key={index}
              ...
              <div className="w-full max-w-[500px] min-h-[100px] transition-all duration-300">
                {answers[currentAnswer - 1]}
              </div>

              <Text className="mt-3 w-full text-end max-w-[500px] text-[#f0ecec] font-medium">
            ...
            .{/* searches */}
            <div className="w-full items-center mob:hidden flex gap-[21px] justify-end px-[30px] mb-[27px] mob:px-5 mob:gap-2 mt-7">
            ...
            <div
              className={`relative w-full border border-[#fff] rounded-t-[12px] input-gradient py-4 px-8 min-h-[60px] mob:hidden
            `}
            >
              {/* Images preview area */}
              <div className="relative">
